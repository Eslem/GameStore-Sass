...
INSERT INTO `producto` (`id`, `video`, `nombre`, `descripcion`, `precio`)
VALUES (9, 'MZIqFbn2MeQ', 'Bioshock Infinite', 'Gracias al auge de los Estados Unidos como potencia mundial, la ciudad flotante de Columbia, lanzada con gran pompa ante los vitores de un publico entregado, es un importantisimo simbolo de los ideales americanos.', 50);
/*INSERT INTO `producto` (`id`, `nombre`, `descripcion`, `precio`) 
...
INSERT INTO `producto` (`id`, `video`, `nombre`, `descripcion`, `precio`) 
VALUES (10, 't-xyxmg7lyU', 'Lord of the Rings Online', 'Lord Of The Rings Online (LOTRO) es el primer MMORPG ambientado en el mundo de El Señor de los Anillos de JRR Tolkien. LOTRO tiene lugar en un mundo online persistente poblado con jugadores reales y NPCs que seguiran funcionando incluso si apagas el juego. Una de las ventajas de jugar LOTRO es la amplia gama de jugadores, que ofrece muchas opciones cuando los jugadores estan buscando disfrutar del juego con otras personas.', 50);
