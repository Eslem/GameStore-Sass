...
VALUES (1, 'Dragon Age: Inquisition', 'Un cataclismo ha sumido las tierras de Thedas en la confusión. Los Dragones oscurecen los cielos, invocando a las sombras del terror sobre el reino que en un tiempo fue pacífico. Los Magos inician una guerra sin cuartel contra los opresivos Templarios. Las naciones se levantan unas contra otras. Depende de ti y de tu grupo de héroes legendarios restablecer el orden como lider de la inquisición, cazando a los agentes del caos.', 50);
INSERT INTO `tienda`.`producto` (`id`, `nombre`, `descripcion`, `precio`) 
